export const PortfolioList = [
  ...
  },
  {
    ...
    listImgs: [
      { id: 1, item: "/imgs/max-frontend-screen.png" },
      { id: 2, item: "/imgs/max-frontend-screen.png" },
      { id: 3, item: "/imgs/max-frontend-screen.png" },
    ],
    link: "https://github.com/mstarkRules",
    description:
...

  {
    ...
    listImgs: [
      { id: 1, item: "/imgs/dt-money-screen.png" },
      { id: 2, item: "/imgs/dt-money-screen.png" },
      { id: 3, item: "/imgs/dt-money-screen.png" },
    ],
    link: "https://github.com/mstarkRules/02-dt-money",
    description:
...

  {
    ...
    listImgs: [
      { id: 1, item: "/imgs/rocketshoes.png" },
      { id: 2, item: "/imgs/rocketshoes.png" },
      { id: 3, item: "/imgs/rocketshoes.png" },
    ],
  ...
  },
  {
    ...
    img: "/imgs/meus-trabalhos.jpg",
    listImgs: [
      { id: 1, item: "/imgs/meus-trabalhos.jpg" },
      { id: 2, item: "/imgs/meus-trabalhos.jpg" },
      { id: 3, item: "/imgs/meus-trabalhos.jpg" },
    ],
    link: "https://github.com/mstarkRules/meustrabalhos",
    description:
      "Aplicação móvel feita para o meu Trabalho de Conclusão do Curso de Sistemas de Informação. O aplicativo funciona como uma agenda eletrônicas de atividades escolares, e permite adicionar trabalhos e calcular notas automaticamente.",
  },
];
